                                                ...
                                                <div class="all-ads main-grid-border">
                                                    <div class="container">
                                                        <div class="select-box">
                                                                <form action="{{ isset($category) ? 'categories/'.$category->slug : 'all-classifieds' }}" method="GET" id="filter">
                                                                    <div class="col-md-4">
                                                                                    ...
                                                                                    <div class="all-categories">                           
                                                                                            <ul class="all-cat-list">                                                                    
                                                                                                    @foreach($category->children as $sub)
                                                                                                        <li><a href="/categories/{{$category->slug}}/{{$sub->slug}}">{{ $sub->name }}<span class="num-of-ads">({{ $sub->adCount() }})</span></a></li>
                                                                                                    @endforeach
                                                                                            </ul>
                                                                                    </div>         
                                                                        @endif
